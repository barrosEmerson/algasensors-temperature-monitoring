...
import com.barrositcompany.algasenrors.tempature.monitoring.api.model.SensorMonitoringOutputDTO;
...
public class SensorMonitoringController {
    ...
    @GetMapping
    public SensorMonitoringOutputDTO getSensorMonitoring(@PathVariable TSID sensorId) {
